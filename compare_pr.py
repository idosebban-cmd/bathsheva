...
def main():
    ...
    lines += ["",
              ...
              f"* Exit area {ib['pr_exit_area']:.0f} mm2 = {ib['pr_exit_area'] / ib['pr_sd']:.2f} x radiator "
              f"area (base style: {p.BASE_STYLE}).",
              f"* Body underside {ib['z0']:.1f} mm off the ground (rear layout: {results[1]['z0']:.1f} mm).",
